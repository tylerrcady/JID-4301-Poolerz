            ...
            <div className="flex-col justify-start items-start gap-[35px] inline-flex">
                <div className="w-[575px] h-[392px] px-[34px] py-[25px] bg-white rounded-md shadow flex-col justify-start items-start gap-[25px] flex">
                    <div className="justify-center items-center gap-7 inline-flex">
                        <div className="w-[426px] text-blue text-2xl font-bold font-['Open Sans']">My Profile</div>
                    ...
                    <div className="self-stretch grow shrink basis-0 relative">
                        <div className="w-[431.81px] left-0 top-0 absolute text-black text-2xl font-bold font-['Open Sans']">{name}</div>
                        <div className="w-[447.40px] left-[-0px] top-[43.40px] absolute text-gray text-xl font-normal font-['Open Sans']">{email}</div>
                    </div>
                    <div className="self-stretch grow shrink basis-0 relative">
                        <div className="w-[431.81px] left-0 top-0 absolute text-black text-xl font-bold font-['Open Sans']">Role</div>
                        <div className="w-[447.40px] left-0 top-[31px] absolute text-gray text-base font-normal font-['Open Sans']">Parent</div>
                    </div>
                    <div className="w-[447.40px] text-[#e50606] text-base font-normal font-['Open Sans']">Log out</div>
                </div>
            </div>
            <div className="flex-col justify-center items-start gap-11 inline-flex">
                <div className="w-[575px] h-[327px] px-[33.60px] py-[25.20px] bg-white rounded-md shadow flex-col justify-start items-start gap-[25.20px] flex">
                    <div className="h-[286.60px] flex-col justify-start items-start gap-[19px] flex">
                        <div className="justify-center items-center gap-7 inline-flex">
                            <div className="w-[399px] text-blue text-2xl font-bold font-['Open Sans']">Family</div>
                                <div className="h-[22px] relative flex items-center gap-2 cursor-pointer">
                                    <Button
                                        icon={<AddIcon/>}
                                        text="Add"
                            ...
                            <div className="w-[476.20px] h-[107.80px] relative">
                                <div className="w-[431.81px] left-0 top-0 absolute text-black text-2xl font-bold font-['Open Sans']">Child A</div>
                                <div className="w-[447.80px] h-16 left-[28.40px] top-[43.80px] absolute flex-col justify-start items-start gap-2.5 inline-flex">
                                    <div className="self-stretch text-gray text-xl font-normal font-['Open Sans']">Centerville Choir Group</div>
                                    <div className="self-stretch text-gray text-xl font-normal font-['Open Sans']">Fairport High Cross Country</div>
                                </div>
                            </div>
                            <div className="h-[107.80px] relative">
                                <div className="w-[431.81px] left-0 top-0 absolute text-black text-2xl font-bold font-['Open Sans']">Child B</div>
                    ...
                    <div className="w-[575px] h-[327px] px-[33.60px] py-[25.20px] bg-white rounded-md shadow flex-col justify-start items-start gap-[25.20px] flex">
                        <div className="flex-col justify-start items-start gap-[19px] flex">
                            <div className="w-[426px] text-blue text-2xl font-bold font-['Open Sans']">Driving Availability</div>
                        </div>
                    </div>
            </div>
        </div>
